...
exports.oracleConfig = exports.sqlServerConfig = void 0;
exports.initSqlServerPool = initSqlServerPool;
exports.getSqlServerConnection = getSqlServerConnection;
const dotenv_1 = __importDefault(require("dotenv"));
const mssql_1 = __importDefault(require("mssql"));
dotenv_1.default.config();
exports.sqlServerConfig = {
...
async function initSqlServerPool() {
    try {
        const pool = await mssql_1.default.connect(exports.sqlServerConfig);
...
async function getSqlServerConnection() {
    return mssql_1.default.connect(exports.sqlServerConfig);
}
